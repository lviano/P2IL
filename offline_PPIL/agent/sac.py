...
class SAC(object):
    def __init__(self, obs_dim, action_dim, action_range, batch_size, args):
        ...
        self.get_reward = hydra.utils.instantiate(agent_cfg.critic_cfg, args=args).to(self.device)
        ...
        self.reward_optimizer = Adam(self.get_reward.parameters(), lr=agent_cfg.critic_lr,
                                     betas=agent_cfg.critic_betas)    
    ...
    def train(self, training=True):
        ...
        self.get_reward.train(training)
