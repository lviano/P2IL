...
with open("data_cheetah_ours.pkl", "wb") as f:
...
for i, run in enumerate(runs):
    if run.name in ["IQ new data", "IQ new data 2", "IQ new data 3","IQ new data 4", "IQ new data 5"]:
        time_list = []
        rewards = [] 
        # run.summary are the output key/values like accuracy.
        # We call ._json_dict to omit large files 
...
with open("data_cheetah_iq_ours.pkl", "wb") as f:
