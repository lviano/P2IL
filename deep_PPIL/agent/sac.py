...
class SAC(object):
    def __init__(self, obs_dim, action_dim, action_range, batch_size, args):
        ...
        self.reward = hydra.utils.instantiate(agent_cfg.critic_cfg, args=args).to(self.device)
        
        #self.reward_target = hydra.utils.instantiate(agent_cfg.critic_cfg, args=args).to(
        #    self.device)
        #self.reward_target.load_state_dict(self.reward.state_dict())
        ...
        self.reward_optimizer = Adam(self.reward.parameters(), lr=agent_cfg.critic_lr,
                                     betas=agent_cfg.critic_betas)
