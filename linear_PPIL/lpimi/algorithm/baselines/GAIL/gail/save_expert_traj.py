...
if is_disc_state:
    pickle.dump((expert_traj), open(os.path.join(assets_dir(), 'expert_traj/{}_expert_traj.p'.format(args.env_name)), 'wb'))
    torch.save({"trajectories":expert_traj_lpimi}, open(os.path.join(assets_dir(), '../../../expert_traj/{}_expert_traj.pt'.format(args.env_name)), 'wb'))
else:
