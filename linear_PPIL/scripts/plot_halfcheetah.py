...
"""
for env, max_env, min_env in zip(["HalfCheetah-v2"], [5200.0], [-10.0]):
    fig = plt.figure()
    ...
    """
    with open("results/data_halfcheetah.pkl","rb") as f:
    ...
    with open("results/data_halfcheetah_iq.pkl","rb") as f:
        dictionaries = pickle.load(f)
    xs=None
    mean=None
