...
dictionary = { "TwoStateProblem-v0": [lambda seed: "results/TwoStateProblem"+str(seed)+"forb0.5.pt",
               ...
               "TwoStateStochastic-v0": [lambda seed: "results/TwoStateStochastic"+str(seed)+"forb0.5.pt",
                ...
                "RiverSwim-v0": [lambda seed: "results/RiverSwim"+str(seed)+"forb0.2.pt",
...
seed_ranges= { "TwoStateProblem-v0": [np.arange(0,20,2),np.arange(0,20,2),np.arange(0,20,2),np.arange(0,20,2)],
               "TwoStateStochastic-v0": [np.arange(0,20,2),np.arange(0,20,2),np.arange(0,20,2),np.arange(0,20,2)],
               "WideTree-v0": [np.arange(0,20,2),np.arange(0,20,2),range(10), range(10)],
               "RiverSwim-v0": [np.arange(0,20,2),np.arange(0,20,2),range(10), range(10)],
               "SingleChainProblem-v0": [np.arange(0,20,2),np.arange(0,20,2),range(10), range(10)],
               "DoubleChainProblem-v0": [np.arange(0,20,2),np.arange(0,20,2),range(10), range(10)],
               "WindyGrid-v0": [range(50), range(50),range(50),range(50)]}
...
for env in ["TwoStateProblem-v0", 
    ...
    if env in ["SingleChainProblem-v0", 
        ...
        ax.plot(np.mean(x_tot, axis=0)[:-1:3]/100,np.mean(y_tot, axis=0)[:-1:3],"-o",color="yellow",label="IQ SGD")
        ax.fill_between(np.mean(x_tot, axis=0)[:-1:3]/100,
                np.mean(y_tot, axis=0)[:-1:3] + np.std(y_tot, axis=0)[:-1:3],
                np.mean(y_tot, axis=0)[:-1:3] - np.std(y_tot, axis=0)[:-1:3], alpha=0.1, facecolor="yellow")
         
    else:
        ax.plot(np.mean(x_tot, axis=0)/100,np.mean(y_tot, axis=0),"-o",color="yellow",label="IQ SGD")
        ax.fill_between(np.mean(x_tot, axis=0)/100,
                np.mean(y_tot, axis=0) + np.std(y_tot, axis=0),
                np.mean(y_tot, axis=0) - np.std(y_tot, axis=0), alpha=0.1, facecolor="yellow")
    ...
    if env in ["WindyGrid-v0",
                "SingleChainProblem-v0", 
                "DoubleChainProblem-v0"]:
        ax.plot(np.mean(x_tot, axis=0)[:-1:3]/100,np.mean(y_tot, axis=0)[:-1:3],"-o",color="goldenrod",label="IQ FORB")
        ax.fill_between(np.mean(x_tot, axis=0)[:-1:3]/100,
                np.mean(y_tot, axis=0)[:-1:3] + np.std(y_tot, axis=0)[:-1:3],
                np.mean(y_tot, axis=0)[:-1:3] - np.std(y_tot, axis=0)[:-1:3], alpha=0.1, facecolor="goldenrod")
    else:
        ax.plot(np.mean(x_tot, axis=0)/100,np.mean(y_tot, axis=0),"-o",color="goldenrod",label="IQ FORB")
        ax.fill_between(np.mean(x_tot, axis=0)/100,
                np.mean(y_tot, axis=0) + np.std(y_tot, axis=0),
                np.mean(y_tot, axis=0) - np.std(y_tot, axis=0), alpha=0.1, facecolor="goldenrod")
    ...
    plt.tight_layout()
    plt.savefig("figs/"+env+"_baseline_comparison.pdf")