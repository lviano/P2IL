...
for env, max_env, min_env in zip(["HalfCheetah-v2"], [2690.0], [-9.0]):
    fig = plt.figure()
    ...
    with open("results/data_cheetah_ours.pkl","rb") as f:
    ...
    with open("results/data_cheetah_iq_ours.pkl","rb") as f:
        dictionaries = pickle.load(f)
    xs=None
    mean=None
